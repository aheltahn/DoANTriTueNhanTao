...
export const VIETNAM_PROVINCES = [
  { id: 1, name: "Hà Nội", lat: 21.028, lng: 105.8542, region: "Miền Bắc" },
  {
    id: 2,
    name: "Hồ Chí Minh",
    lat: 10.7765,
  ...
  { id: 6, name: "An Giang", lat: 10.5216, lng: 105.423, region: "Miền Nam" }, // Long Xuyên
  {
    id: 7,
  ...
  { id: 9, name: "Bắc Kạn", lat: 22.147, lng: 105.8348, region: "Miền Bắc" },
  { id: 10, name: "Bạc Liêu", lat: 9.2942, lng: 105.7277, region: "Miền Nam" },
  { id: 11, name: "Bắc Ninh", lat: 21.1861, lng: 106.071, region: "Miền Bắc" },
  ...
  { id: 18, name: "Cao Bằng", lat: 22.666, lng: 106.258, region: "Miền Bắc" },
  { id: 19, name: "Đắk Lắk", lat: 12.71, lng: 108.2377, region: "Miền Trung" }, // Buôn Ma Thuột - Sửa
  {
    id: 20,
    name: "Đắk Nông",
    lat: 11.9375,
  ...
  { id: 24, name: "Gia Lai", lat: 13.9833, lng: 108.0, region: "Miền Trung" }, // Pleiku
  { id: 25, name: "Hà Giang", lat: 22.8019, lng: 104.9786, region: "Miền Bắc" },
  { id: 26, name: "Hà Nam", lat: 20.54, lng: 105.914, region: "Miền Bắc" }, // Phủ Lý
  { id: 27, name: "Hà Tĩnh", lat: 18.342, lng: 105.9056, region: "Miền Trung" },
  { id: 28, name: "Hải Dương", lat: 20.939, lng: 106.3307, region: "Miền Bắc" },
  { id: 29, name: "Hậu Giang", lat: 9.7827, lng: 105.4663, region: "Miền Nam" }, // Vị Thanh
  { id: 30, name: "Hòa Bình", lat: 20.827, lng: 105.34, region: "Miền Bắc" },
  ...
  { id: 35, name: "Lai Châu", lat: 22.396, lng: 103.458, region: "Miền Bắc" },
  { id: 36, name: "Lâm Đồng", lat: 11.9465, lng: 108.4419, region: "Miền Nam" }, // Đà Lạt - Sửa
  { id: 37, name: "Lạng Sơn", lat: 21.8525, lng: 106.761, region: "Miền Bắc" },
  { id: 38, name: "Lào Cai", lat: 22.4856, lng: 103.9707, region: "Miền Bắc" },
  { id: 39, name: "Long An", lat: 10.6956, lng: 106.243, region: "Miền Nam" }, // Tân An
  ...
  { id: 44, name: "Phú Thọ", lat: 21.3262, lng: 105.132, region: "Miền Bắc" }, // Việt Trì
  {
    id: 45,
    name: "Phú Yên",
    lat: 13.1046,
  ...
  { id: 52, name: "Sơn La", lat: 21.327, lng: 103.918, region: "Miền Bắc" },
  { id: 53, name: "Tây Ninh", lat: 11.3085, lng: 106.0957, region: "Miền Nam" },
  { id: 54, name: "Thái Bình", lat: 20.446, lng: 106.34, region: "Miền Bắc" },
  {
    id: 55,
    name: "Thái Nguyên",
    lat: 21.5942,
  ...
  { id: 58, name: "Tiền Giang", lat: 10.3722, lng: 106.36, region: "Miền Nam" }, // Mỹ Tho
