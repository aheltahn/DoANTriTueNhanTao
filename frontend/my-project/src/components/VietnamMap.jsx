...
const VietnamMap = ({ selectedProvinces, onProvinceSelect, currentLocation }) => {
          ...
          >
            <Popup className="custom-popup vietnam-popup">
              <div className="text-center">
                <div className="text-lg font-bold text-blue-600">Vị trí của bạn</div>
            ...
            <Tooltip permanent direction="top" className="custom-tooltip vietnam-tooltip current-tooltip">
              Vị trí của bạn
            </Tooltip>
          </Marker>
        )}
